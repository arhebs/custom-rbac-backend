...
def create_seed_roles() -> dict[str, Role]:
...
def create_seed_elements() -> dict[str, BusinessElement]:
...
def create_seed_rules(roles: dict[str, Role], elements: dict[str, BusinessElement]) -> None:
...
def create_seed_sample_users_and_articles(roles: dict[str, Role]) -> None:
...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        """Register CLI flags for the seed_rbac management command."""
        parser.add_argument(
            "--reset",
            action="store_true",
            help=(
    ...
    def handle(self, *args, **options):
        ...
        create_seed_sample_users_and_articles(roles)
